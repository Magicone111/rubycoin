...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 5938
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 5937
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 55937
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 5938
	%{_sbindir}/semanage port -d -p tcp 5937
	%{_sbindir}/semanage port -d -p tcp 18332
	%{_sbindir}/semanage port -d -p tcp 55937
